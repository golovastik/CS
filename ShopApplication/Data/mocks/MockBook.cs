        ...
        public IEnumerable<Book> Books
        {
            get
            {
                return new List<Book>
                {
                    ...
                    new Book{name = "C# .NET Core", shortDesc = "", longDesc = "для супер пупер прогГеров", img = "/img/NETCore.jpg", price = 110, availabel = true, Category = _categoryBooks.AllCategories.First()},
